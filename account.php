...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || Splash Books</title>
  ...
  <body >
    ...
    <div class="row" style="margin-top:20px;">
      <div class="small-12">
        ...
        <p><h4>Account Details/Updates</h4></p>
    ...
    <div class="small-12 hehh " style="margin-top:100px; padding-top: 23px;background-color:#0078A0; height: 315px; width: 100%; ">
